<template>
  <div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--3-col-desktop mdl-cell--4-col-tablet mdl-cell--12-col-phone">
    <div class="row">
      ...
      <button :id="noteindex" class="menu mdl-button mdl-js-button mdl-button--icon mdl-js-ripple-effect">
        <i class="material-icons mdl-color-text--grey-700">more_vert</i>
      </button>
      <ul :for="noteindex" class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect">
